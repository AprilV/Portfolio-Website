  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Risk Management", experience: "Academic", description: "Project Management I & II coursework", accent: "success-green" },
        { name: "Stakeholder Communication", experience: "20+ Years", description: "Extensive professional experience", accent: "orange-accent" },
        { name: "Team Leadership", experience: "18+ Years", description: "Led 12-person teams at Dell Technologies", accent: "purple-accent" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "LAN Administration", experience: "20+ Years + Academic", description: "Professional experience + IS 346 LAN Administration IV (4.0 GPA)", accent: "orange-accent" },
        { name: "Cisco Networking", experience: "Academic", description: "CIS 270 Cisco I (4.0) + CIS 271 Cisco II (4.0 GPA)", accent: "accent-blue" },
        ...
        { name: "Web Development", experience: "Academic", description: "CIS 155 - Web Development I (4.0 GPA)", accent: "accent-blue" },
        { name: "Network Security", experience: "Academic", description: "CIS 236 - Info System Security I (4.0 GPA)", accent: "navy" },
        { name: "Programming Concepts", experience: "Academic", description: "CIS 141 - Programming Concepts (3.8 GPA)", accent: "purple-accent" },
        { name: "Operating Systems", experience: "Academic", description: "CIS 111 - Intro to Operating Systems (4.0 GPA)", accent: "success-green" },
        { name: "Server Support", experience: "Academic", description: "CIS 241 - Applications Server Support (4.0 GPA)", accent: "accent-blue" },
        { name: "Technical Support", experience: "Academic + Professional", description: "CIS 172 - Technical Support Skills (4.0 GPA) + 20+ years experience", accent: "success-green" },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Information Systems Foundations", experience: "Academic", description: "IS 300 - IS Foundations (4.0 GPA)", accent: "navy" },
        { name: "Research & Analysis", experience: "Academic", description: "IS 390 - Reading and Research (4.0 GPA)", accent: "orange-accent" },
        { name: "Digital Leadership", experience: "Academic", description: "IS 320 - Leading in the Digital World (4.0 GPA)", accent: "purple-accent" },
        { name: "Business Foundations", experience: "Academic", description: "BUS& 101 - Intro to Business (4.0 GPA)", accent: "success-green" },
        { name: "Technical Writing", experience: "Academic + Professional", description: "ENGL& 235 - Technical Writing (4.0 GPA) + 20+ years experience", accent: "accent-blue" },
        { name: "Organizational Communication", experience: "Academic", description: "CMST 242 - Intro Comm in Organizations (4.0 GPA)", accent: "orange-accent" },
        { name: "Interpersonal Communication", experience: "Academic", description: "CMST& 210 - Interpersonal Communication (4.0 GPA)", accent: "purple-accent" },
      ],
    },
  ];
