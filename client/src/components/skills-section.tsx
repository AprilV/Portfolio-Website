  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Risk Management", experience: "Academic", description: "Project Management I & II coursework", accent: "navy" },
        { name: "Agile Methodologies", experience: "Academic + Projects", description: "Coursework & capstone implementation", accent: "accent-blue" },
      ],
    },
    {
      ...
      color: "success-green",
      skills: [
        { name: "Information Systems Integration", experience: "Academic + Professional", description: "IS 302 (4.0 GPA) + Top LinkedIn skill", accent: "purple-accent" },
        { name: "Digital Leadership", experience: "Academic", description: "IS 320 - Leading in the Digital World (4.0 GPA)", accent: "navy" },
        { name: "Business Analysis", experience: "Academic", description: "BUS 215 Business Statistics (3.7) + BUS& 101 Intro (4.0)", accent: "accent-blue" },
        { name: "Process Improvement", experience: "20+ Years", description: "Operational efficiency and system optimization", accent: "success-green" },
        { name: "Research & Analysis", experience: "Academic", description: "IS 390 - Reading and Research (4.0 GPA)", accent: "orange-accent" },
        { name: "Cross-functional Coordination", experience: "20+ Years", description: "Multi-departmental project coordination", accent: "purple-accent" },
      ],
    },
    {
      ...
      color: "accent-blue",
      skills: [
        { name: "LAN Administration", experience: "20+ Years + Academic", description: "Professional experience + IS 346 LAN Administration IV (4.0)", accent: "orange-accent" },
        { name: "Windows Systems", experience: "20+ Years + Academic", description: "Professional + CIS 212 Windows/Professionals (4.0)", accent: "success-green" },
        { name: "Network Security", experience: "Academic", description: "CIS 236 - Info System Security I (4.0 GPA)", accent: "navy" },
        { name: "Cisco Networking", experience: "Academic", description: "CIS 270 Cisco I (4.0) + CIS 271 Cisco II (4.0)", accent: "accent-blue" },
        { name: "Technical Support", experience: "20+ Years + Academic", description: "CIS 172 Technical Support Skills (4.0) + professional experience", accent: "purple-accent" },
        { name: "Server Support", experience: "Academic", description: "CIS 241 - Applications Server Support (4.0 GPA)", accent: "success-green" },
      ],
    },
  ];
