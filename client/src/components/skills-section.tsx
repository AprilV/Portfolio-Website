  ...
  const academicRecognition = [
    {
      ...
      detail: "President's Scholar (9 terms) | 3.94 GPA | end of Spring term 2026",
      icon: GraduationCap,
      color: "primary-blue",
      link: null,
        ...
        <div className="text-center mb-16">
          ...
          >
            <div className="professional-experience-header">
              ...
              <p className="section-subtitle">Blending professional IT experience with academic project management training</p>
            </div>
          </motion.div>
        </div>
