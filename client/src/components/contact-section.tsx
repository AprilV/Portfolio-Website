        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="professional-card p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6" aria-describedby="contact-instructions" noValidate>
              ...
              {/* CAPTCHA Section */}
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-600 transition-colors duration-300">
                <label htmlFor="captcha" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">
                  Security Verification *
                </label>
                <div className="flex items-center gap-4">
                  <div className="bg-white dark:bg-gray-700 px-4 py-2 rounded border border-gray-300 dark:border-gray-500 font-mono text-lg text-gray-900 dark:text-gray-100 transition-colors duration-300">
                    {captcha.question} = ?
                  </div>
                  <Input
                    id="captcha"
                ...
                <p id="captcha-help" className="text-xs text-gray-600 dark:text-gray-400 mt-2 transition-colors duration-300">
